				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'single' ); ?>>
					<header class="single-header">
						...
						<div class="single-meta">
							...
							<span class="single-reading"><?php echo esc_html( nolan_showcase_03_estimated_read_time( get_the_content() ) ); ?></span>
						</div>
					</header>
					...
					<footer class="single-footer">
						...
						<nav class="post-nav" aria-label="<?php echo esc_attr__( 'Post navigation', 'nolan-showcase-theme-03' ); ?>">
