...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'post-card' ); ?> data-reveal>
	<header class="post-card__head">
		...
		<p class="post-card__meta">
			...
			<span>
				...
				echo $cats ? wp_kses_post( $cats ) : esc_html__( 'Uncategorized', 'nolan-showcase-theme-05' );
				?>
			</span>
		</p>
	</header>
	...
	<a class="btn btn-text" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read more', 'nolan-showcase-theme-05' ); ?></a>
</article>
