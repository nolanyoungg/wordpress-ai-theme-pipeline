<?php
/**
 * Nolan Showcase Theme 04 functions and definitions.
 *
...
function nolan_x9_setup() {
	load_theme_textdomain( 'nolan-showcase-theme-04', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'primary' => __( 'Primary menu', 'nolan-showcase-theme-04' ),
			'footer'  => __( 'Footer menu', 'nolan-showcase-theme-04' ),
		)
	);
}
...
function nolan_x9_widgets_init() {
	register_sidebar(
		array(
			'name'          => __( 'Sidebar', 'nolan-showcase-theme-04' ),
			'id'            => 'sidebar-1',
			'description'   => __( 'Add widgets here.', 'nolan-showcase-theme-04' ),
...
function nolan_x9_get_brand_name() {
	return __( 'MNY Photo', 'nolan-showcase-theme-04' );
}
