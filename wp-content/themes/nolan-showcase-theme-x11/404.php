...
<section class="section section--tight">
	<div class="container container--narrow">
		<div class="error" data-reveal>
			<p class="error__kicker"><?php esc_html_e( '404', 'nolan-showcase-theme-x11' ); ?></p>
			<h1 class="error__title"><?php esc_html_e( 'That page isn’t here.', 'nolan-showcase-theme-x11' ); ?></h1>
			<p class="error__copy"><?php esc_html_e( 'Try a search, or jump to one of the main pages below.', 'nolan-showcase-theme-x11' ); ?></p>
			<div class="error__actions">
				<a class="btn btn-primary" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Go home', 'nolan-showcase-theme-x11' ); ?></a>
				<a class="btn btn-secondary" href="<?php echo esc_url( home_url( '/work/' ) ); ?>"><?php esc_html_e( 'View work', 'nolan-showcase-theme-x11' ); ?></a>
			</div>
		</div>
