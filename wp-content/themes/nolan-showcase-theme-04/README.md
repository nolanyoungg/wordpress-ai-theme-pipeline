# Nolan Showcase Theme 04 (MNY Photo)

Bright, clean, modern editorial photography theme for **MNY Photo**.
...
- The navigation includes a premium Nolan menu system (desktop rail panels + mobile drawer) with keyboard support.
