...
<section class="section section--tight">
	<div class="container">
		<header class="section-head">
			...
			<p class="section-subtitle"><?php echo esc_html__( 'Latest posts and updates.', 'nolan-showcase-theme-05' ); ?></p>
		</header>
		...
		<div class="grid grid--posts">
			...
			if ( have_posts() ) {
				...
				the_posts_navigation(
					array(
						'prev_text' => __( 'Newer posts', 'nolan-showcase-theme-05' ),
						'next_text' => __( 'Older posts', 'nolan-showcase-theme-05' ),
					)
				);
			} else {
